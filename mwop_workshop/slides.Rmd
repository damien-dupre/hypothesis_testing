...
```{r out.width='60%'}
include_img("cronbach_save_2.png")
```
...
```{r}
include_img("jamovi_regression_example.gif")
```
...
```{r out.width='60%'}
include_img("jamovi_regression_table.png")
```
...
```{r}
include_img("mediation_jamovi_jamm.gif")
```
