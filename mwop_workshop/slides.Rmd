...
# "~/Library/CloudStorage/OneDrive-Personal/Media/assets/orchestra.jpg"
```
...
```{r out.width = "50%"}
include_graphics("img/ex1_title.png")
```

```{r out.width = "50%"}
include_graphics("img/ex1_hyp.png")
```
...
```{r out.width = "50%"}
include_graphics("img/ex2_title.png")
```

```{r out.width = "50%"}
include_graphics("img/ex2_hyp1.png")
```

```{r out.width = "50%"}
include_graphics("img/ex2_hyp2.png")
```
